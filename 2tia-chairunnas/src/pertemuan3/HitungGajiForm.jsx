...
import InputFieldGaji from "./components/InputFieldGaji";
import OutputGaji from "./components/OutputGaji";
...
export default function HitungGajiForm() {
    ...
    return (
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <InputFieldGaji label='Hitung Gaji' type='number' placeholder='Masukkan gaji' onChange={(e) => setGaji(e.target.value)} />
